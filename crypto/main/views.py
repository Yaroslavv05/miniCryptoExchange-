...
def index(request):
    data = {
        ...
        'ETH': {'price': round(float(client.get_ticker(symbol='ETHUSDT')['lastPrice']) * 1.03, 4),
        ...
        'BNB': {'price': round(float(client.get_ticker(symbol='BNBUSDT')['lastPrice']) * 1.03, 4),
        ...
        'ADA': {'price': round(float(client.get_ticker(symbol='ADAUSDT')['lastPrice']) * 1.03, 4),
        ...
        'XRP': {'price': round(float(client.get_ticker(symbol='XRPUSDT')['lastPrice']) * 1.03, 4),
        ...
        'DOT': {'price': round(float(client.get_ticker(symbol='DOTUSDT')['lastPrice']) * 1.03, 4),
        ...
        'UNI': {'price': round(float(client.get_ticker(symbol='UNIUSDT')['lastPrice']) * 1.03, 4),
